...
namespace WeaponThread {   
    partial class Weapons {
        ...
        WeaponDefinition LargeVulcan => new WeaponDefinition {

            Assignments = new ModelAssignmentsDef 
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "LargeVulcan",
                        AimPartId = "None",
            ...
            {
                WeaponName = "LargeVulcan", // name of weapon in terminal
                ...
                Loading = new LoadingDef {
                    RateOfFire = 2200, // visual only, 0 disables and uses RateOfFire
                    BarrelsPerShot = 1,
