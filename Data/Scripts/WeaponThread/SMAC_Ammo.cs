    ...
    partial class Weapons
    {
		...
		private AmmoDef MXA_SMAC_Ammo => new AmmoDef
        {
            ...
            AreaEffect = new AreaDamageDef
            {
                ...
                {
                    Radius = 3f, // the sphere of influence of area effects
                    EffectStrength = 40000f, // For ewar it applies this amount per pulse/hit, non-ewar applies this as damage per tick per entity in area of influence. For radiant 0 == use spillover from BaseDamage, otherwise use this value.
                },
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 75f,
                        Width = 1.5f,
                        Color = Color(red: 30f, green: 25f, blue: 22.5f, alpha: 1f),
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 45,
                        Color = Color(red: 15f, green: 12.5f, blue: 11.5f, alpha: 1),
                        Back = false,
                        CustomWidth = 1.8f,
		...
		private AmmoDef MXA_SMAC_HPImpact => new AmmoDef
        {
            ...
            HybridRound = true, //AmmoMagazine based weapon with energy cost
            EnergyCost = 400f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 280f,
            Mass = 0f, // in kilograms
            Health = 0, // 0 = disabled, otherwise how much damage it can take from other trajectiles before dying.
            BackKickForce = 7500f,
		...
		private AmmoDef MXA_SMAC_HPAmmo => new AmmoDef
        {
            ...
            AreaEffect = new AreaDamageDef
            {
                ...
                Base = new AreaInfluence
                {
                    Radius = 4f, // the sphere of influence of area effects
                    EffectStrength = 49500f, // For ewar it applies this amount per pulse/hit, non-ewar applies this as damage per tick per entity in area of influence. For radiant 0 == use spillover from BaseDamage, otherwise use this value.
                },
                Pulse = new PulseDef // interval measured in game ticks (60 == 1 second), pulseChance chance (0 - 100) that an entity in field will be hit
                {
                    Interval = 0,
