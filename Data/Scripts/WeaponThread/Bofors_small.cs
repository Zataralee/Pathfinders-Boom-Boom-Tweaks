...
{   // Don't edit above this line
    ...
    {
        WeaponDefinition Bofors_small => new WeaponDefinition {

            Assignments = new ModelAssignmentsDef 
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "40mmBofors_small",
                        AimPartId = "None",
            ...
            HardPoint = new HardPointDef 
            {
                ...
                Loading = new LoadingDef {
                    RateOfFire = 160, // visual only, 0 disables and uses RateOfFire
                    BarrelsPerShot = 4,
                ...
                Audio = new HardPointAudioDef {
                    PreFiringSound = "",
                    FiringSound = "40mmBofors", // WepShipGatlingShot
