...
{ // Don't edit above this line
    ...
    {
        private AmmoDef MXA_CoilgunL_Ammo => new AmmoDef
        {
            ...
            {
                AmmoRound = "MXA_CoilgunL_Shrapnel",
                Fragments = 25,
                Degrees = 100,
                Reverse = false,
            ...
            {
                ModelName = "\\Models\\Coilguns\\MXA_Coil155Ammo.mwm",
		...
		private AmmoDef MXA_CoilgunL_Shrapnel => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "MXA_CoilgunL_Shrapnel",
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 1f,
                        Width = 0.1f,
                        Color = Color(red: 3, green: 3, blue: 3f, alpha: 1),
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "WeaponLaser",
		...
		private AmmoDef MXA_CoilgunL_HE => new AmmoDef
        {
            AmmoMagazine = "MXA_Coil155HEAmmo",
            AmmoRound = "HE",
            HybridRound = true, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.32f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 0f, //1485f
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                DamageVoxels = false, // true = voxels are vulnerable to this weapon
                SelfDamage = false, // true = allow self damage.
                HealthHitModifier = 15f, // defaults to a value of 1, this setting modifies how much Health is subtracted from a projectile per hit (1 = per hit).
                VoxelHitModifier = -1f,
                Characters = 1f,
                // modifier values: -1 = disabled (higher performance), 0 = no damage, 0.01 = 1% damage, 2 = 200% damage.
                FallOff = new FallOffDef
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    Hit = new ParticleDef
                    {
                        Name = "Explosion_Warhead_02", //Collision_Sparks
                        ApplyToShield = true,
                        ShrinkByDistance = false,
                        Color = Color(red: 10.5f, green: 6.25f, blue: 0, alpha: 1),
                        Offset = Vector(x: 0, y: 0, z: 0),
                        Extras = new ParticleOptionDef
                        {
                            Loop = true,
		...
		private AmmoDef MXA_CoilgunL_AMFlak => new AmmoDef
        {
            AmmoMagazine = "MXA_Coil155HEAmmo",
            AmmoRound = "Flak",
            HybridRound = true, //AmmoMagazine based weapon with energy cost
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    Hit = new ParticleDef
                    {
                        ...
                        ApplyToShield = true,
                        ShrinkByDistance = false,
                        Color = Color(red: 10.5f, green: 6.25f, blue: 3.75f, alpha: 1f),
                        Offset = Vector(x: 0, y: 0, z: 0),
                        Extras = new ParticleOptionDef
                        {
                            Loop = true,
		...
		private AmmoDef MXA_CoilgunL_Flak => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "MXA_CoilgunL_Flak",
            HybridRound = true, //AmmoMagazine based weapon with energy cost
            EnergyCost = 15f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 10f, //1485f
            Mass = 75f, // in kilograms
            Health = 0, // 0 = disabled, otherwise how much damage it can take from other trajectiles before dying.
            BackKickForce = 5000f,
            DecayPerShot = 0f,
