...
namespace WeaponThread {   
    partial class Weapons {
        ...
        WeaponDefinition SmallVulcan => new WeaponDefinition {

            Assignments = new ModelAssignmentsDef 
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "SmallVulcan",
                        AimPartId = "None",
            ...
            {
                WeaponName = "SmallVulcan", // name of weapon in terminal
                ...
                Loading = new LoadingDef {
                    RateOfFire = 1000, // visual only, 0 disables and uses RateOfFire
                    BarrelsPerShot = 1,
                    ...
                    BarrelSpinRate = 1000, // visual only, 0 disables and uses RateOfFire
                    DeterministicSpin = false, // Spin barrel position will always be relative to initial / starting positions (spin will not be as smooth).
                },
                Audio = new HardPointAudioDef {
                    PreFiringSound = "",
                    FiringSound = "Vulcan", // WepShipGatlingShot
