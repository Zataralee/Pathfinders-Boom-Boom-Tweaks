...
{ // Don't edit above this line
    ...
    {
        private AmmoDef MXA_SoFCoilgun_Ammo => new AmmoDef
        {
            AmmoMagazine = "MXA_Coil270Ammo",
            AmmoRound = "AP",
            HybridRound = true, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.32f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 700f, //1485f
            Mass = 105f, // in kilograms
            ...
            {
                AmmoRound = "MXA_SoFCoilgun_Shrapnel",
                Fragments = 25,
                Degrees = 100,
                Reverse = false,
            ...
            {
                ModelName = "\\Models\\Coilguns\\MXA_Coil270Ammo.mwm",
		...
		private AmmoDef MXA_SoFCoilgun_Shrapnel => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "MXA_SoFCoilgun_Shrapnel",
		...
		private AmmoDef MXA_SoFCoilgun_HEAmmo => new AmmoDef
        {
            AmmoMagazine = "MXA_Coil270HEAmmo",
            AmmoRound = "HE",
            HybridRound = true, //AmmoMagazine based weapon with energy cost
            EnergyCost = 32f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 7f, //1485f
            Mass = 105f, // in kilograms
            Health = 0, // 0 = disabled, otherwise how much damage it can take from other trajectiles before dying.
            BackKickForce = 7000f,
