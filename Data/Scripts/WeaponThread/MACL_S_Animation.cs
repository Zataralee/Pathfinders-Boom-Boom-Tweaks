...
{ // Don't edit above this line
    partial class Weapons
    {
        ...
        private AnimationDef MXA_MACL_S_Animation => new AnimationDef
        {
                    ...
                    EventMoveSets = new Dictionary<PartAnimationSetDef.EventTriggers, RelMove[]>
                    {
                        ...
                        [PreFire] =
                            new[] //Firing, Reloading, Overheated, Tracking, On, Off, BurstReload, OutOfAmmo, PreFire define a new[] for each
                            {
                                ...
                                {
                                    CenterEmpty = "",
                                    TicksToMove = 96, //number of ticks to complete motion, 60 = 1 second
                                    MovementType = Linear,
                                    LinearPoints = new[]
                                    {
                                        Transformation(0, 0, -10.11), //linear movement
                                    },
                    ...
                    EventMoveSets = new Dictionary<PartAnimationSetDef.EventTriggers, RelMove[]>
                    {
						...
						[PreFire] =
                            new[] //Firing, Reloading, Overheated, Tracking, On, Off, BurstReload, OutOfAmmo, PreFire define a new[] for each
                            {
                                ...
                                {
                                    CenterEmpty = "",
                                    TicksToMove = 126, //number of ticks to complete motion, 60 = 1 second
                                    MovementType = Delay,
