...
namespace WeaponThread {   
    partial class Weapons {
        ...
        WeaponDefinition odin_def => new WeaponDefinition {
            ...
            Assignments = new ModelAssignmentsDef 
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "odin",
                        AimPartId = "None",
                        MuzzlePartId = "MissileTurretBarrelsTubes",
            ...
            {
                WeaponName = "HFC-800 ODIN", // name of weapon in terminal
                ...
                Loading = new LoadingDef {
                    ...
                    MaxHeat = 12000, //max heat before weapon enters cooldown (70% of max heat)
