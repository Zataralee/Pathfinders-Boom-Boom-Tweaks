...
namespace WeaponThread {   
    partial class Weapons {
        ...
        WeaponDefinition SmallAden => new WeaponDefinition {
            ...
            {
                WeaponName = "SmallAden", // name of weapon in terminal
                ...
                Loading = new LoadingDef {
                    RateOfFire = 400, // visual only, 0 disables and uses RateOfFire
                    BarrelsPerShot = 1,
                ...
                Audio = new HardPointAudioDef {
                    PreFiringSound = "",
                    FiringSound = "Aden", // WepShipGatlingShot
