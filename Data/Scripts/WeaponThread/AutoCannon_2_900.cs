...
{   // Don't edit above this line
    ...
    {
        WeaponDefinition AutoCannon_2_900 => new WeaponDefinition {

            Assignments = new ModelAssignmentsDef 
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "AutoCannon_2_900",
                        AimPartId = "None",
            ...
            {
                WeaponName = "2x900mm Auto Cannon", // name of weapon in terminal
                ...
                Loading = new LoadingDef {
                    RateOfFire = 16, // visual only, 0 disables and uses RateOfFire
                    BarrelsPerShot = 1,
                ...
                Audio = new HardPointAudioDef {
                    PreFiringSound = "",
                    FiringSound = "900mmCannon", // WepShipGatlingShot
            ...
            Ammos = new [] {
                Autocannon900Ammo_HE,
                Autocannon900Ammo_AP
            },
