...
namespace WeaponThread {   
    partial class Weapons {
        ...
        WeaponDefinition MXA_SMAC => new WeaponDefinition {
            ...
            {
                WeaponName = "Series 8 MAC", // name of weapon in terminal
                ...
                Loading = new LoadingDef {
                    ...
                    DelayUntilFire = 318, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                ...
                Audio = new HardPointAudioDef {
                    PreFiringSound = "MXA_SMAC_Charge",
                    FiringSound = "MXA_SMAC_Fire", // WepShipGatlingShot
