...
{ // Don't edit above this line
    ...
    {
        private AmmoDef MXA_CoilgunH_Ammo => new AmmoDef
        {
            AmmoMagazine = "MXA_Coil305Ammo",
            AmmoRound = "AP",
            ...
            {
                ModelName = "\\Models\\Coilguns\\MXA_Coil305Ammo.mwm",
                ...
                Lines = new LineDef
                {
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 6,
                        Color = Color(red: 1.875f, green: 1.5625f, blue: 0.9375f, alpha: .5f),
                        Back = false,
                        CustomWidth = 0.1f,
		...
		private AmmoDef MXA_CoilgunH_APFuse => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "MXA_CoilgunH_APFuse",
            ...
            AreaEffect = new AreaDamageDef
            {
                ...
                Base = new AreaInfluence
                {
                    Radius = 1.6f, // the sphere of influence of area effects
                    EffectStrength = 225f, // For ewar it applies this amount per pulse/hit, non-ewar applies this as damage per tick per entity in area of influence. For radiant 0 == use spillover from BaseDamage, otherwise use this value.
                },
                Pulse = new PulseDef // interval measured in game ticks (60 == 1 second), pulseChance chance (0 - 100) that an entity in field will be hit
                {
                    Interval = 0,
                ...
                Detonation = new DetonateDef
                {
                    DetonateOnEnd = true,
                    ArmOnlyOnHit = false,
                    DetonationDamage = 112.5f,
                    DetonationRadius = 3.2f,
                    MinArmingTime = 0, //Min time in ticks before projectile will arm for detonation (will also affect shrapnel spawning)
                },
                EwarFields = new EwarFieldsDef
                {
		...
		private AmmoDef MXA_CoilgunH_Shrapnel => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "MXA_CoilgunH_Shrapnel",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
		...
		private AmmoDef MXA_CoilgunH_HEAmmo => new AmmoDef
        {
            AmmoMagazine = "MXA_Coil305HEAmmo",
            AmmoRound = "HE",
            HybridRound = true, //AmmoMagazine based weapon with energy cost
            EnergyCost = 11.5f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 250f,
            Mass = 150f, // in kilograms
            Health = 0, // 0 = disabled, otherwise how much damage it can take from other trajectiles before dying.
            BackKickForce = 90000f,
            ...
            AmmoGraphics = new GraphicDef
            {
                ModelName = "\\Models\\Coilguns\\MXA_Coil305HEAmmo.mwm",
                VisualProbability = 1f,
                ShieldHitDraw = true,
                Particles = new AmmoParticleDef
                {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 20f,
                        Width = 0.1f,
                        Color = Color(red: 20.25f, green: 6.25f, blue: 3.75f, alpha: 1f),
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "ProjectileTrailLine",
		...
		private AmmoDef MXA_CoilgunH_GStage => new AmmoDef
        {
            AmmoMagazine = "MXA_Coil305GAmmo",
            AmmoRound = "Guided",
            HybridRound = true, //AmmoMagazine based weapon with energy cost
            ...
            AmmoGraphics = new GraphicDef
            {
                ModelName = "\\Models\\Coilguns\\MXA_Coil305GAmmo.mwm",
                VisualProbability = 1f,
                ShieldHitDraw = true,
                Particles = new AmmoParticleDef
                {
		...
		private AmmoDef MXA_CoilgunH_GAmmo => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "MXA_CoilgunH_GAmmo",
            HybridRound = true, //AmmoMagazine based weapon with energy cost
