...
{   // Don't edit above this line
    ...
    {
        WeaponDefinition Side300Cannonsmall => new WeaponDefinition {

            Assignments = new ModelAssignmentsDef 
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Side300Cannonsmall",
                        AimPartId = "None",
            ...
            {
                WeaponName = "300mm Casemate Cannon", // name of weapon in terminal
                ...
                Loading = new LoadingDef {
                    RateOfFire = 6, // visual only, 0 disables and uses RateOfFire
                    BarrelsPerShot = 1,
