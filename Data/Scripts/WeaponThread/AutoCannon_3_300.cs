...
{   // Don't edit above this line
    ...
    {
        WeaponDefinition AutoCannon_3_300 => new WeaponDefinition {

            Assignments = new ModelAssignmentsDef 
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "AutoCannon_3_300",
                        AimPartId = "None",
            ...
            {
                WeaponName = "3x300mm Auto Cannon", // name of weapon in terminal
                ...
                Loading = new LoadingDef {
                    RateOfFire = 36, // visual only, 0 disables and uses RateOfFire
                    BarrelsPerShot = 1,
