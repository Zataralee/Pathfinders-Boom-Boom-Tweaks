...
namespace WeaponThread {   
    partial class Weapons {
        ...
        WeaponDefinition MiniVulcan => new WeaponDefinition {

            Assignments = new ModelAssignmentsDef 
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "MiniVulcan",
                        AimPartId = "None",
            ...
            {
                WeaponName = "MiniVulcan", // name of weapon in terminal
                ...
                Loading = new LoadingDef {
                    RateOfFire = 800, // visual only, 0 disables and uses RateOfFire
                    BarrelsPerShot = 1,
