...
{ // Don't edit above this line
    ...
    {
        private AmmoDef MXA_Sabre_Coilgun_Ammo => new AmmoDef
        {
		...
		private AmmoDef MXA_Sabre_Coilgun_Shrapnel => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "MXA_Sabre_Coilgun_Shrapnel",
            ...
            AreaEffect = new AreaDamageDef
            {
                ...
                Base = new AreaInfluence
                {
                    ...
                    EffectStrength = 250f, // For ewar it applies this amount per pulse/hit, non-ewar applies this as damage per tick per entity in area of influence. For radiant 0 == use spillover from BaseDamage, otherwise use this value.
                },
                Pulse = new PulseDef // interval measured in game ticks (60 == 1 second), pulseChance chance (0 - 100) that an entity in field will be hit
                {
                    Interval = 0,
