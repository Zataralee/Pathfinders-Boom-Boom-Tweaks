...
namespace WeaponThread {   
    partial class Weapons {
        ...
        WeaponDefinition SmallSentryGatling => new WeaponDefinition {

            Assignments = new ModelAssignmentsDef 
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "SmallSentryGatling",
                        AimPartId = "None",
            ...
            {
                WeaponName = "SmallSentryGatling", // name of weapon in terminal
                ...
                Loading = new LoadingDef {
                    RateOfFire = 500, // visual only, 0 disables and uses RateOfFire
                    BarrelsPerShot = 1,
