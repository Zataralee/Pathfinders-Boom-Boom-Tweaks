...
namespace WeaponThread {   
    partial class Weapons {
        ...
        WeaponDefinition SmallSentryGun => new WeaponDefinition {

            Assignments = new ModelAssignmentsDef 
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "SmallSentryGun",
                        AimPartId = "None",
            ...
            {
                WeaponName = "SmallSentryGun", // name of weapon in terminal
                ...
                Loading = new LoadingDef {
                    RateOfFire = 250, // visual only, 0 disables and uses RateOfFire
                    BarrelsPerShot = 1,
